...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  private FragmentRegisterBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextView loginLink, @NonNull TextInputEditText passwordInput,
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegisterBinding((ScrollView) rootView, emailInput, emailLayout, loginLink,
          passwordInput, passwordLayout, registerButton, usernameInput, usernameLayout);
    }
